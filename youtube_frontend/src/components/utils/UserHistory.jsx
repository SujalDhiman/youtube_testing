...
export function UserHistory() {
  ...
  {
      const response=await axios.get(`${URL}/users/deleteWatchHistory/${_id}`,{
          withCredentials:true
      })

      console.log("after deleting watch History ",response)
      setHistory([])
  }
        ...
        <div className="w-full lg:w-4/12 flex justify-center items-center">
          <div className="flex flex-col items-center">
            <div className="flex items-center bg-black rounded-xl shadow-xl cursor-pointer">
              ...
              <p className="font-bold text-lg p-4" onClick={clearAllHistory}>Clear all watch history</p>
            </div>
          </div>
        </div>
